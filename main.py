...
folium.TileLayer('NASAGIBS Blue Marble',attr='NASAGIBS Blue Marble', show=False).add_to(m)

folium.TileLayer('MapQuest Open Aerial',attr='MapQuest Open Aerial', show=False).add_to(m)
	
folium.TileLayer('stamenwatercolor',attr='stamenwatercolor',show=False).add_to(m)
